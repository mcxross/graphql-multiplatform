...
package xyz.mcxross.graphql.client.converter

/**
 * Custom GraphQL scalar JSON converter that is used to convert between raw JSON String
 * representation and typesafe scalar value.
 */
