...
open class GraphQLPluginClientExtension {
  /**
   * GraphQL server endpoint that will be used to for running introspection queries. Alternatively
   * you can download schema directly from [sdlEndpoint] or specify local [schemaFile].
   */
  var endpoint: String? = null
  /**
   * GraphQL server SDL endpoint that will be used to download schema. Alternatively you can run
   * introspection query against [endpoint] or specify local [schemaFile].
   */
  ...
  /**
   * List of custom GraphQL scalar to converter mapping containing information about corresponding
   * Java type and converter that should be used to serialize/deserialize values.
   */
  ...
  /**
   * Configure options for parsing GraphQL queries and schema definition language documents.
   * Settings here override the defaults set by GraphQL Java.
   */
