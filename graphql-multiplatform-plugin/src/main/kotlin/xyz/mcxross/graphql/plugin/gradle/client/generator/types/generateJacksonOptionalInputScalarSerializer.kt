...
import xyz.mcxross.graphql.client.converter.ScalarConverter
...
internal fun generateJacksonOptionalInputScalarSerializer(
  customScalars: Collection<GraphQLScalar>
): TypeSpec {
  val jacksonOptionalInput =
    ClassName("xyz.mcxross.graphql.client.jackson.types", "OptionalInput").parameterizedBy(STAR)
  val jacksonDefinedInput =
    MemberName("xyz.mcxross.graphql.client.jackson.types", "OptionalInput.Defined")
  val jacksonUndefinedInput =
          ...
          .add(
            customScalars
              .map { scalarInfo ->
                CodeBlock.of(
                  "%T::class.java to %T()",
                  scalarInfo.className,
                  scalarInfo.converterClassName,
                )
              }
              .joinToCode()
          )
