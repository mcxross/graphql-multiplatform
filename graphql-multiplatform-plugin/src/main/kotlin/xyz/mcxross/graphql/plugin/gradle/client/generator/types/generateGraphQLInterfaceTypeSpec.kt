...
/**
 * Generate interface [TypeSpec] from the GraphQL interface definition based on the specified
 * selection set.
 *
...
internal fun generateGraphQLInterfaceTypeSpec(
  ...
  val implementations =
    context.graphQLSchema.getImplementationsOf(interfaceDefinition).map { it.name }
