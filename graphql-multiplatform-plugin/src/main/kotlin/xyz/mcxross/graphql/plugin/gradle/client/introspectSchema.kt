      ...
      runBlocking {
          ...
          try {
            client
              .post {
                ...
                httpHeaders.forEach { (name, value) -> header(name, value) }
                setBody(
                  mapOf("query" to INTROSPECTION_QUERY, "operationName" to "IntrospectionQuery")
                )
                expectSuccess = true
              }
              .body<Map<String, Any?>>()
            ...
            when (e) {
              ...
              is UnknownHostException -> throw e
                ...
                throw RuntimeException(
                  "Unable to run introspection query against the specified endpoint=$endpoint",
                  e,
                )
            }
          }
        ...
        val graphQLDocument =
          IntrospectionResultToSchema()
            .createSchemaDefinition(introspectionResult["data"] as? Map<String, Any?>)
        val options =
