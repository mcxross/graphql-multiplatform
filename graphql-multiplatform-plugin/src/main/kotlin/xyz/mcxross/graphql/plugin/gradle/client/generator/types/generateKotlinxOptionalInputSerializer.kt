...
internal fun generateKotlinxOptionalInputSerializer(
  ...
  val optionalClassName =
    if (isList) {
      LIST.parameterizedBy(elementClassName)
    } else {
      elementClassName
    }
  val kotlinxOptionalInput =
    ClassName("xyz.mcxross.graphql.client.serialization.types", "OptionalInput")
      .parameterizedBy(optionalClassName)
  val kotlinxDefinedInput =
    ClassName("xyz.mcxross.graphql.client.serialization.types", "OptionalInput.Defined")
      .parameterizedBy(optionalClassName)
  val kotlinxUndefinedInput =
    ClassName("xyz.mcxross.graphql.client.serialization.types", "OptionalInput.Undefined")
  val kSerializer =
    ClassName("kotlinx.serialization", "KSerializer").parameterizedBy(optionalClassName)
  ...
  return TypeSpec.objectBuilder(typeName)
    ...
    .addFunction(
      FunSpec.builder("deserialize")
        ...
        .addCode(
          CodeBlock.of(
            "return OptionalInput.Defined(decoder.decodeNullableSerializableValue(delegate.%M))",
